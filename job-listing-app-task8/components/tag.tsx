...
const categoryStyles: Record<string, string> = {
  'Education Access and Quality Improvement': 'border-2 border-pink-100 text-pink-900',
  'Youth Empowerment and Development': 'border-2 border-purple-100 text-purple-900',
  IT: 'border-2 border-blue-100 text-blue-900',
  'Orphanages and Child Welfare': 'border-2 border-green-100 text-green-900',
  'Data Science': 'border-2 border-yellow-100 text-yellow-900',
  Category1: 'border-2 border-red-100 text-red-900',
  'Customer Service': 'border-2 border-cyan-100 text-cyan-900',
  Category2: 'border-2 border-teal-100 text-teal-900',
